...
class ListenCommand extends Command
{
    public function configure()
    {
        ...
        $this->addArgument('connection', \Symfony\Component\Console\Input\InputArgument::REQUIRED, 'Name of the connection to use');
        $this->addArgument('queue', \Symfony\Component\Console\Input\InputArgument::REQUIRED, 'Name of the queue to work on');
        ...
        $this->addOption('graceful-shutdown', null, \Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Activating this switch will cause the listener to wait for child processes to finish before exiting');
    }
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $poolWorker = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\TYPO3Incubator\Jobqueue\PoolWorker::class, $backend, $queue, $limit, $useSignals);
        ...
        if($disableSignalHandling === false) {
            ...
            \TYPO3Incubator\Jobqueue\Utility::applySignalHandling([SIGTERM, SIGQUIT, SIGHUP, SIGINT, SIGQUIT], function($sig) use($callable) {
