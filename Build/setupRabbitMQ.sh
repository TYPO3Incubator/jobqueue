...
if [ $1 = "ADD" ]; then
    ...
    echo;
    rabbitmqadmin declare queue name=fanout1 auto_delete=true durable=true arguments='{"x-dead-letter-exchange":"typo3.direct", "x-dead-letter-routing-key":"failed-direct"}';
    rabbitmqadmin declare queue name=fanout2 auto_delete=false durable=true arguments='{"x-dead-letter-exchange":"typo3.direct", "x-dead-letter-routing-key":"failed-direct"}';
    ...
    echo;
    rabbitmqadmin declare queue name=topic1 auto_delete=true durable=true arguments='{"x-dead-letter-exchange":"typo3.direct", "x-dead-letter-routing-key":"failed-direct"}';
    rabbitmqadmin declare queue name=topic2 auto_delete=true durable=true arguments='{"x-dead-letter-exchange":"typo3.direct", "x-dead-letter-routing-key":"failed-direct"}';
